...
// Pano2VR 6.0/17213
// Filename: simplex_v6_3.ggsk
// Generated 周一 二月 11 11:05:49 2019
...
function pano2vrSkin(player,base) {
		...
		me._tt_zoomin.logicBlock_position = function() {
			...
			if (me._tt_zoomin.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me._tt_zoomin.ggCurrentLogicStatePosition == 0) {
					...
					me._tt_zoomin.ggDx=24;
					me._tt_zoomin.style.top='-93px';
					me._tt_zoomin.ggUpdatePosition(true);
				}
			}
		}
	...
	me.callChildLogicBlocksHotspot_ht_node_mouseover = function(){
		if(hotspotTemplates['ht_node']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_node'].length; i++) {
				if (hotspotTemplates['ht_node'][i]._button_image_up && hotspotTemplates['ht_node'][i]._button_image_up.logicBlock_scaling) {
					hotspotTemplates['ht_node'][i]._button_image_up.logicBlock_scaling();
				}
				if (hotspotTemplates['ht_node'][i]._button_image_up && hotspotTemplates['ht_node'][i]._button_image_up.logicBlock_alpha) {
					hotspotTemplates['ht_node'][i]._button_image_up.logicBlock_alpha();
				}
				if (hotspotTemplates['ht_node'][i]._hotspot_preview && hotspotTemplates['ht_node'][i]._hotspot_preview.logicBlock_visible) {
					hotspotTemplates['ht_node'][i]._hotspot_preview.logicBlock_visible();
				}
				...
				if (hotspotTemplates['ht_node'][i]._tt_ht_node && hotspotTemplates['ht_node'][i]._tt_ht_node.logicBlock_scaling) {
					hotspotTemplates['ht_node'][i]._tt_ht_node.logicBlock_scaling();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_url_mouseover = function(){
		if(hotspotTemplates['ht_url']) {
			...
			for(i = 0; i < hotspotTemplates['ht_url'].length; i++) {
				...
				if (hotspotTemplates['ht_url'][i]._tt_ht_url && hotspotTemplates['ht_url'][i]._tt_ht_url.logicBlock_scaling) {
					hotspotTemplates['ht_url'][i]._tt_ht_url.logicBlock_scaling();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_info_mouseover = function(){
		if(hotspotTemplates['ht_info']) {
			...
			for(i = 0; i < hotspotTemplates['ht_info'].length; i++) {
				...
				if (hotspotTemplates['ht_info'][i]._tt_information && hotspotTemplates['ht_info'][i]._tt_information.logicBlock_scaling) {
					hotspotTemplates['ht_info'][i]._tt_information.logicBlock_scaling();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_image_mouseover = function(){
		if(hotspotTemplates['ht_image']) {
			...
			for(i = 0; i < hotspotTemplates['ht_image'].length; i++) {
				...
				if (hotspotTemplates['ht_image'][i]._tt_ht_image && hotspotTemplates['ht_image'][i]._tt_ht_image.logicBlock_scaling) {
					hotspotTemplates['ht_image'][i]._tt_ht_image.logicBlock_scaling();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_video_vimeo_mouseover = function(){
		if(hotspotTemplates['ht_video_vimeo']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_vimeo'].length; i++) {
				if (hotspotTemplates['ht_video_vimeo'][i]._ht_video_vimeo_image && hotspotTemplates['ht_video_vimeo'][i]._ht_video_vimeo_image.logicBlock_scaling) {
					hotspotTemplates['ht_video_vimeo'][i]._ht_video_vimeo_image.logicBlock_scaling();
				}
				if (hotspotTemplates['ht_video_vimeo'][i]._tt_ht_video_vimeo && hotspotTemplates['ht_video_vimeo'][i]._tt_ht_video_vimeo.logicBlock_visible) {
					hotspotTemplates['ht_video_vimeo'][i]._tt_ht_video_vimeo.logicBlock_visible();
				}
				if (hotspotTemplates['ht_video_vimeo'][i]._tt_ht_video_vimeo && hotspotTemplates['ht_video_vimeo'][i]._tt_ht_video_vimeo.logicBlock_scaling) {
					hotspotTemplates['ht_video_vimeo'][i]._tt_ht_video_vimeo.logicBlock_scaling();
				}
			}
		}
	}
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		me._ht_node.onmouseover=function (e) {
			...
			me._button_image_up.logicBlock_scaling();
			me._button_image_up.logicBlock_alpha();
			me._hotspot_preview.logicBlock_visible();
			me._tt_ht_node.logicBlock_visible();
			me._tt_ht_node.logicBlock_scaling();
		...
		me._button_image_up.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(me.elementMouseOver['ht_node'] == true)
			)
			...
			if (me._button_image_up.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._button_image_up.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._button_image_up.style[domTransition]='' + cssPrefix + 'transform 2000ms ease 0ms, opacity 2000ms ease 0ms, visibility 2000ms ease 0ms';
				if (me._button_image_up.ggCurrentLogicStateScaling == 0) {
					me._button_image_up.ggParameter.sx = 2;
					me._button_image_up.ggParameter.sy = 2;
					me._button_image_up.style[domTransform]=parameterToTransform(me._button_image_up.ggParameter);
				}
				else {
					me._button_image_up.ggParameter.sx = 1;
					me._button_image_up.ggParameter.sy = 1;
					me._button_image_up.style[domTransform]=parameterToTransform(me._button_image_up.ggParameter);
				}
			}
		}
		me._button_image_up.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				(me.elementMouseOver['ht_node'] == true)
			)
			...
			if (me._button_image_up.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._button_image_up.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._button_image_up.style[domTransition]='' + cssPrefix + 'transform 2000ms ease 0ms, opacity 2000ms ease 0ms, visibility 2000ms ease 0ms';
				if (me._button_image_up.ggCurrentLogicStateAlpha == 0) {
					me._button_image_up.style.visibility=me._button_image_up.ggVisible?'inherit':'hidden';
					me._button_image_up.style.opacity=0.5;
				}
				else {
					me._button_image_up.style.visibility=me._button_image_up.ggVisible?'inherit':'hidden';
					me._button_image_up.style.opacity=1;
				}
			}
		}
		...
		me._ht_node.appendChild(me._button_image_up);
		...
		me._hsimage.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(player.getViewerSize().width / player.getViewerSize().height == 2)
			)
			{
				newLogicStateScaling = 0;
			}
			...
			if (me._hsimage.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				me._hsimage.style[domTransition]='' + cssPrefix + 'transform 1000ms ease 0ms';
				if (me._hsimage.ggCurrentLogicStateScaling == 0) {
					me._hsimage.ggParameter.sx = 2;
					me._hsimage.ggParameter.sy = 2;
		...
		me._tt_ht_node.logicBlock_position = function() {
			...
			if (me._tt_ht_node.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._tt_ht_node.style[domTransition]='left 0s, top 0s, ' + cssPrefix + 'transform 2000ms ease 0ms';
		...
		me._tt_ht_node.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(me.elementMouseOver['ht_node'] == true)
			)
			...
			if (me._tt_ht_node.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._tt_ht_node.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._tt_ht_node.style[domTransition]='left 0s, top 0s, ' + cssPrefix + 'transform 2000ms ease 0ms';
				if (me._tt_ht_node.ggCurrentLogicStateScaling == 0) {
					me._tt_ht_node.ggParameter.sx = 2;
					me._tt_ht_node.ggParameter.sy = 2;
					me._tt_ht_node.style[domTransform]=parameterToTransform(me._tt_ht_node.ggParameter);
				}
				else {
					me._tt_ht_node.ggParameter.sx = 1;
					me._tt_ht_node.ggParameter.sy = 1;
					me._tt_ht_node.style[domTransform]=parameterToTransform(me._tt_ht_node.ggParameter);
				}
			}
		}
	...
	function SkinHotspotClass_ht_url(parentScope,hotspot) {
		...
		me._ht_url.onmouseover=function (e) {
			...
			me._tt_ht_url.logicBlock_scaling();
			skin.hotspotProxyOver(me.hotspot.id, me.hotspot.url);
		}
		...
		me._ht_url_image.logicBlock_scaling = function() {
			...
			if (me._ht_url_image.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				me._ht_url_image.style[domTransition]='' + cssPrefix + 'transform 2000ms ease 0ms';
				if (me._ht_url_image.ggCurrentLogicStateScaling == 0) {
					me._ht_url_image.ggParameter.sx = 2;
					me._ht_url_image.ggParameter.sy = 2;
		...
		me._tt_ht_url.logicBlock_position = function() {
			...
			if (me._tt_ht_url.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._tt_ht_url.style[domTransition]='left 0s, top 0s, ' + cssPrefix + 'transform 2000ms ease 0ms';
		...
		me._tt_ht_url.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(me.elementMouseOver['ht_url'] == true)
			)
			...
			if (me._tt_ht_url.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._tt_ht_url.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._tt_ht_url.style[domTransition]='left 0s, top 0s, ' + cssPrefix + 'transform 2000ms ease 0ms';
				if (me._tt_ht_url.ggCurrentLogicStateScaling == 0) {
					me._tt_ht_url.ggParameter.sx = 2;
					me._tt_ht_url.ggParameter.sy = 2;
					me._tt_ht_url.style[domTransform]=parameterToTransform(me._tt_ht_url.ggParameter);
				}
				else {
					me._tt_ht_url.ggParameter.sx = 1;
					me._tt_ht_url.ggParameter.sy = 1;
					me._tt_ht_url.style[domTransform]=parameterToTransform(me._tt_ht_url.ggParameter);
				}
			}
		}
	...
	function SkinHotspotClass_ht_info(parentScope,hotspot) {
		...
		me._ht_info.onmouseover=function (e) {
			...
			me._tt_information.logicBlock_scaling();
			skin.hotspotProxyOver(me.hotspot.id, me.hotspot.url);
		}
		...
		me._ht_info_image.logicBlock_scaling = function() {
			...
			if (me._ht_info_image.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				me._ht_info_image.style[domTransition]='' + cssPrefix + 'transform 2000ms ease 0ms';
				if (me._ht_info_image.ggCurrentLogicStateScaling == 0) {
					me._ht_info_image.ggParameter.sx = 2;
					me._ht_info_image.ggParameter.sy = 2;
		...
		me._tt_information.logicBlock_position = function() {
			...
			if (me._tt_information.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._tt_information.style[domTransition]='left 0s, top 0s, ' + cssPrefix + 'transform 2000ms ease 0ms';
		...
		me._tt_information.logicBlock_scaling = function() {
			...
			if (me._tt_information.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me._tt_information.ggCurrentLogicStateScaling == 0) {
					me._tt_information.ggParameter.sx = 2;
					me._tt_information.ggParameter.sy = 2;
	...
	function SkinHotspotClass_ht_image(parentScope,hotspot) {
		...
		me._ht_image.onmouseover=function (e) {
			...
			me._tt_ht_image.logicBlock_scaling();
			skin.hotspotProxyOver(me.hotspot.id, me.hotspot.url);
		}
		...
		me._ht_image_image.logicBlock_scaling = function() {
			...
			if (me._ht_image_image.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				me._ht_image_image.style[domTransition]='' + cssPrefix + 'transform 2000ms ease 0ms';
				if (me._ht_image_image.ggCurrentLogicStateScaling == 0) {
					me._ht_image_image.ggParameter.sx = 2;
					me._ht_image_image.ggParameter.sy = 2;
		...
		me._tt_ht_image.logicBlock_position = function() {
			...
			if (me._tt_ht_image.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._tt_ht_image.style[domTransition]='left 0s, top 0s, ' + cssPrefix + 'transform 2000ms ease 0ms';
		...
		me._tt_ht_image.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(me.elementMouseOver['ht_image'] == true)
			)
			...
			if (me._tt_ht_image.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._tt_ht_image.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._tt_ht_image.style[domTransition]='left 0s, top 0s, ' + cssPrefix + 'transform 2000ms ease 0ms';
				if (me._tt_ht_image.ggCurrentLogicStateScaling == 0) {
					me._tt_ht_image.ggParameter.sx = 2;
					me._tt_ht_image.ggParameter.sy = 2;
					me._tt_ht_image.style[domTransform]=parameterToTransform(me._tt_ht_image.ggParameter);
				}
				else {
					me._tt_ht_image.ggParameter.sx = 1;
					me._tt_ht_image.ggParameter.sy = 1;
					me._tt_ht_image.style[domTransform]=parameterToTransform(me._tt_ht_image.ggParameter);
				}
			}
		}
	...
	function SkinHotspotClass_ht_video_vimeo(parentScope,hotspot) {
		...
		me._ht_video_vimeo.onmouseover=function (e) {
			...
			me._ht_video_vimeo_image.logicBlock_scaling();
			me._tt_ht_video_vimeo.logicBlock_visible();
			me._tt_ht_video_vimeo.logicBlock_scaling();
			skin.hotspotProxyOver(me.hotspot.id, me.hotspot.url);
		}
		...
		me._ht_video_vimeo_image.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(me.elementMouseOver['ht_video_vimeo'] == true)
			)
			...
			if (me._ht_video_vimeo_image.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._ht_video_vimeo_image.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._ht_video_vimeo_image.style[domTransition]='' + cssPrefix + 'transform 2000ms ease 0ms';
				if (me._ht_video_vimeo_image.ggCurrentLogicStateScaling == 0) {
					me._ht_video_vimeo_image.ggParameter.sx = 2;
					me._ht_video_vimeo_image.ggParameter.sy = 2;
					me._ht_video_vimeo_image.style[domTransform]=parameterToTransform(me._ht_video_vimeo_image.ggParameter);
				}
				else {
					me._ht_video_vimeo_image.ggParameter.sx = 1;
					me._ht_video_vimeo_image.ggParameter.sy = 1;
					me._ht_video_vimeo_image.style[domTransform]=parameterToTransform(me._ht_video_vimeo_image.ggParameter);
				}
			}
		}
		...
		me._tt_ht_video_vimeo.logicBlock_position = function() {
			...
			if (me._tt_ht_video_vimeo.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._tt_ht_video_vimeo.style[domTransition]='left 0s, top 0s, ' + cssPrefix + 'transform 2000ms ease 0ms';
		...
		me._tt_ht_video_vimeo.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(me.elementMouseOver['ht_video_vimeo'] == true)
			)
			...
			if (me._tt_ht_video_vimeo.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._tt_ht_video_vimeo.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._tt_ht_video_vimeo.style[domTransition]='left 0s, top 0s, ' + cssPrefix + 'transform 2000ms ease 0ms';
				if (me._tt_ht_video_vimeo.ggCurrentLogicStateScaling == 0) {
					me._tt_ht_video_vimeo.ggParameter.sx = 2;
					me._tt_ht_video_vimeo.ggParameter.sy = 2;
					me._tt_ht_video_vimeo.style[domTransform]=parameterToTransform(me._tt_ht_video_vimeo.ggParameter);
				}
				else {
					me._tt_ht_video_vimeo.ggParameter.sx = 1;
					me._tt_ht_video_vimeo.ggParameter.sy = 1;
					me._tt_ht_video_vimeo.style[domTransform]=parameterToTransform(me._tt_ht_video_vimeo.ggParameter);
				}
			}
		}
